...
int WINAPI WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPSTR lpCmdLine, _In_ int nCmdShow)
{
	...
	while (1)
	{
		...
		vectorDistance = lineStartCirclVec.cross(normLineVec);
		...
		if (isHit){
			DrawCircle(circlePos.x, circlePos.y, circleR, GetColor(255, 0, 0));
		}else
		{
			DrawCircle(circlePos.x, circlePos.y, circleR, GetColor(255, 255, 255));
		}
